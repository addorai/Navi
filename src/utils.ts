...
class NaviUtils {
  ...
  private promptApiKey() {
    ...
    const userInputApiKey = readlineSync.question("Enter your OpenAI API key: ", {
      hideEchoBack: true,
    });
  ...
  public async fetchGptResults(error: string, cwd: string) {
    ...
    if (this.openai && apiKey) {
      ...
      console.log("No OpenAI API key found. Please run the program again and enter your API key.");
    }
  }
